...
const JokesItemCard = ({ joke }) => {
  return (
    <Card className="group relative overflow-hidden bg-gray-800 border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 rounded-xl">
      {/* Gradient overlay */}
